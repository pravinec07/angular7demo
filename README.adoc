...
If you'd rather use Angular 6, see https://github.com/mraible/Anguler7Demo/blob/41d9526dbc0a35131118f7f101938dfe75a0e212/README.adoc[this version] (also available http://gist.asciidoctor.org/?github-mraible%2FAnguler7Demo%2F41d9526dbc0a35131118f7f101938dfe75a0e212%2F%2FREADME.adoc[via DocGist]). The Angular 5 version is https://github.com/mraible/Anguler7Demo/blob/662159470802c53f445db6393576c0926e31d642/README.adoc[available here].

ifdef::env-github[]
TIP: It appears you're reading this document on GitHub. If you want a prettier view, install https://chrome.google.com/webstore/detail/asciidoctorjs-live-previe/iaalpfgpbocpdfblpnhhgllgbdbchmia[Asciidoctor.js Live Preview for Chrome], then view the https://raw.githubusercontent.com/mraible/Anguler7Demo/master/README.adoc[raw document]. Another option is to use the http://gist.asciidoctor.org/?github-mraible/Anguler7Demo//README.adoc[DocGist view].
endif::[]

.Source Code
****
If you'd like to get right to it, the https://github.com/mraible/Anguler7Demo[source is on GitHub]. To run the app, use `ng serve`. To test it, run `ng test`. To run its integration tests, run `ng e2e`.
****
...
This will create a `Anguler7Demo` project and run `npm install` in it. It takes about a minute to complete,
...
To add a search feature, open the project in an IDE or your favorite text editor. For IntelliJ IDEA, use File > New Project > Static Web and point to the `Anguler7Demo` directory.
...
[TIP]
====
If you didn't complete the previous section, you can clone the Anguler7Demo repository and checkout the `test-start` branch.

----
git clone -b test-start https://github.com/mraible/Anguler7Demo.git
cd Anguler7Demo && npm i
----
====
...
[09:32:00] I/update - chromedriver: file exists /Users/mraible/dev/Anguler7Demo/node_modules/protractor/node_modules/webdriver-manager/selenium/chromedriver_2.43.zip
[09:32:00] I/update - chromedriver: unzipping chromedriver_2.43.zip
[09:32:00] I/update - chromedriver: setting permissions to 0755 for /Users/mraible/dev/Anguler7Demo/node_modules/protractor/node_modules/webdriver-manager/selenium/chromedriver_2.43
...
https://travis-ci.org/mraible/Anguler7Demo/builds/456656948[Here] is a build showing all unit and integration tests passing.
...
echo 'root: Anguler7Demo\npushstate: enabled' > Staticfile
cf push Anguler7Demo
----

NOTE: You might need to use an app name other than `Anguler7Demo`.
...
. Change `package.json` to have a different `start` script.
   ...
   "start": "http-server-spa dist/Anguler7Demo index.html $PORT",
...
A completed project with this code in it is available on GitHub at https://github.com/mraible/Anguler7Demo.
...
* https://github.com/mraible/Anguler7Demo/tree/angular-material#bonus-angular-material[Angular Material]
* https://github.com/mraible/Anguler7Demo/tree/bootstrap4#bonus-bootstrap[Bootstrap 4]
* https://github.com/mraible/Anguler7Demo/tree/okta#bonus-okta[Authentication with Okta]
